 ...
 const [fullscreenimage,setfullscreenimage] = useState("")
    ...
    return(
        ...
        <form className="grid p-4 gap-2 overflow-y-scroll h-full pb-5" onSubmit={handlesubmit}>
           ...
           <input type="sellingprice" id="sellingprice" name='sellingprice' placeholder="enter sellingprice" value={data.sellingprice} onChange={handleOnChange} className="p-2 bg-slate-100 border rounded " required/>
           
           <label  className="mt-3">Description</label>
           <textarea  className="h-28 bg-slate-100 border rounded p-1  resize-non" name="description" row={3} placeholder="enter product description" value={data.description} onChange={handleOnChange} required></textarea>
           

           <button className="px-3 py-2 bg-red-600 mt-3 text-white mb-10 rounded-full w-full max-w-sm justify-center items-center flex mx-auto text-center hover:bg-red-700" required>Upload Product</button>
